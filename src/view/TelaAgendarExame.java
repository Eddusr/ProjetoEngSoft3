...
public class TelaAgendarExame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableConsulta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CPF", "Nome", "Codigo Exame", "Nome", "Data", "Hora"
            }
        ) {
        ...
        if (tableConsulta.getColumnModel().getColumnCount() > 0) {
            tableConsulta.getColumnModel().getColumn(1).setHeaderValue("Nome");
            tableConsulta.getColumnModel().getColumn(2).setHeaderValue("Codigo Exame");
            tableConsulta.getColumnModel().getColumn(3).setHeaderValue("Nome");
        }
